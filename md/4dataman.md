...
#### 1. Make a BESD file from Matrix eQTL output 
...
**NOTE** : 1) The program is able to read \*.tar.gz file. 2) The SNP and probe information in the Matrix eQTL output files are not complete and need to be updated using the options in [Update a BESD file](#UpdateaBESDfile).

#### 2. Make a BESD file from FastQTL output
...
**NOTE** : 1) The FastQTL output file should be generated by a FastQTL version higher than v2.184. 2) The program is able to read \*.tar.gz file. 3) The SNP and probe information in the Matrix eQTL output files are not complete and need to be updated using the options in [Update a BESD file](#UpdateaBESDfile).

#### 3. Make a BESD file from SMR query output
...
#### 4. Make a BESD file from eQTL summary data in ESD format
...
#### 5. Make a BESD file from eQTL summary data in PLINK-qassoc output format
...
#### 6. Make a BESD file from eQTL summary data in GEMMA output format
...
#### 7. Make a BESD file from eQTL summary data in BOLT-LMM output format
...
#### \# Show the sample size on screen

```
smr --beqtl-summary myeqtl --show-n 
```
**\--show-n** shows the sample size on screen.
